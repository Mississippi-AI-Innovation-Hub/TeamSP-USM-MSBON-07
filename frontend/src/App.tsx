        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link to="/" className="hover:opacity-80 transition-opacity flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base font-bold leading-tight">MSBON Transcript Verification</h1>
                <p className="text-xs text-blue-200 leading-tight">Mississippi State Board of Nursing</p>
              </div>
            </Link>
